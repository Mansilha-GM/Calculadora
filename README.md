...
Este projeto é uma **calculadora gráfica em Python** utilizando a biblioteca **Tkinter**.
A interface é inspirada no estilo de calculadoras de celular, com **modo escuro** e **operações destacadas em azul**.
...
A calculadora será aberta em uma janela gráfica.
...
* Layout organizado com sistema **Grid**
* Tema escuro inspirado em calculadoras de celular
